...
// ---------- Content data (edit these and the whole site updates) ----------
const PROFILE = {
  name: "Yash Khare",
  title: "Founder • AI Engineer",
  blurb:
    "Building usable intelligence. I design, ship, and scale AI systems that actually survive production.",
...
const SKILLS = [
  "Python", "FastAPI", "TypeScript", "Next.js", "Postgres", "pgvector", "vLLM", "LangGraph", "Docker", "Kubernetes", "Azure", "Terraform"
];
