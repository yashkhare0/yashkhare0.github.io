...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative flex items-center justify-center space-x-6 rounded-full border border-transparent bg-white px-8 py-4 shadow-input dark:border-white/[0.2] dark:bg-black"
    >
      {children}
    </nav>
  );
